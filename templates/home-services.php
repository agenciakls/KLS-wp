<section class="section home-services">
	<div class="container container-services">
		...
		<hr />
		<p class="description-services text-center">Somos uma agência de <strong>Publicidade</strong> e <strong>Marketing Digital</strong> focada no resultado dos nossos clientes.
		</p>
		
		<div class="content-services splide" id="splide">
				...
				<ul class="splide__list">
					<li class="splide__slide">
						<div class="single-service">
							<div class="img-service">
								...
								<img src="<?php echo get_bloginfo('template_url');?>/img/icons/sociais.png" alt="">
							</div>
					...
					<li class="splide__slide">
						<div class="single-service">
							<div class="img-service">
								...
								<img src="<?php echo get_bloginfo('template_url');?>/img/icons/sites.png" alt="">
							</div>
							<h3 class="title-service">
					...
					<li class="splide__slide">
						<div class="single-service">
							<div class="img-service">
								...
								<img src="<?php echo get_bloginfo('template_url');?>/img/icons/ads.png" alt="">
							</div>
							<h3 class="title-service">
								Gestão de tráfego
							</h3>
					...
					<li class="splide__slide">
						<div class="single-service">
							<div class="img-service">
								<!-- <i class="far fa-thumbs-up"></i> -->
								<img src="<?php echo get_bloginfo('template_url');?>/img/icons/seo.png" alt="">
							</div>
							<h3 class="title-service">
								Seo e Conteúdo
							</h3>
					...
					<li class="splide__slide">
						<div class="single-service">
							<div class="img-service">
								<!-- <i class="far fa-thumbs-up"></i> -->
								<img src="<?php echo get_bloginfo('template_url');?>/img/icons/producao.png" alt="">
							</div>
							<h3 class="title-service">
								Produção e Edição
							</h3>
					...
					<li class="splide__slide">
						<div class="single-service">
							<div class="img-service">
								<!-- <i class="far fa-thumbs-up"></i> -->
								<img src="<?php echo get_bloginfo('template_url');?>/img/icons/design.png" alt="">
							</div>
							<h3 class="title-service">
